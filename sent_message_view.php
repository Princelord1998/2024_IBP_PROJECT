...
<div class="document">
    ...
    <div class="sidebar" id="sidebar">
        <ul>
            ...
            <li><a href="message_box.php"><i class="fa fa-comment-o" style="margin-right: 14px"></i>Inbox</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Message
                            <a href="outbox.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM messages WHERE id='$user_id' ";
                            ...
                            {
                                echo "<h4>No Such Message Found</h4>";
                            }
                        }
                        ?>
                    </div>
