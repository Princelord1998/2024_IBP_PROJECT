                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    ...
                    foreach($query_run as $user)
                    {
                        ...
                        <tr>
                            ...
                            <td><?= $user['date']; ?></td>
                            <td>
                                <a href="admin_reply_view.php?id=<?= $user['id']; ?>" class="btn btn-info btn-sm">View</a>
                                <form action="../action.php" method="POST" class="d-inline">
                                    <button onclick="return confirm('Are you sure you wanna delete message?')" style="width: 60px" type="submit" name="delete_user_message1" value="<?=$user['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
