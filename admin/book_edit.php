            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Book Edit
                            <a href="view_books.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <form action="../action.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label>Title</label>
                                        <input type="text" name="title" value="<?=$user_id['title'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Author</label>
                                        <input type="text" name="author" value="<?=$user_id['author'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
