        ...
        if(isset($_GET['id']))
        {
            ...
            if(mysqli_num_rows($query_run) > 0)
            {
                ...
                <form action="../action.php" method="POST">
                    ...
                    <div class="mb-3">
                        <input type="hidden" name="name" value="<?=$user_id['name'];?>" class="form-control">
                    </div>
                    <div class="mb-3">
                        <input type="textarea" name="data" value="" class="form-control" style="width: 50%;">
                    </div>
                    <div class="mb-3">
                        <button type="submit" name="reply_user" class="btn btn-primary" style="width: 100px">
                            Reply
                        </button>
                    </div>
