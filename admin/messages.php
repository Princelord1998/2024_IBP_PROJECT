...
<div class="document">
    ...
    <div class="sidebar" id="sidebar">
        <ul>
            ...
            <li><a href="messages.php" style="background-color: red"><i class="fa fa-comment-o" style="margin-right: 14px"></i>Inbox</a></li>
                ...
                foreach($query_run as $user)
                {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="reply_message.php?id=<?= $user['user_id']; ?>" class="btn btn-success btn-sm">Reply</a>
                            <form action="../action.php" method="POST" class="d-inline">
                                <button onclick=" return confirm('Are you sure you wanna delete message?')" style="width: 60px" type="submit" name="delete_user_message" value="<?=$user['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                            </form>
                        </td>
                    </tr>
                    <?php
