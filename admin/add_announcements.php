...
<div class="document">
    ...
    <div class="content">
        <div class="card-header">
            <h4>Info To Be Announced
                <a href="dashboard.php" class="btn btn-danger float-end">BACK</a>
            </h4>
        </div>
        <form action="../action.php" method="POST">
            <div class="mb-3">
                <textarea class="form-control" placeholder="Enter announcement" name="announce" style="width: 70%"></textarea>
            </div>
            <div class="mb-3 styled-input">
                <button type="submit" name="announcement" class="btn btn-primary" style="width: 100px">
                    Send
                </button>
            </div>
