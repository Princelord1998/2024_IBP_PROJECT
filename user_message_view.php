...
<div class="document">
    ...
    <div class="sidebar" id="sidebar">
        <ul>
            ...
            <li><a href="message_box.php" style="background-color: red"><i class="fa fa-comment-o" style="margin-right: 14px"></i>Inbox</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Message
                            <a href="message_box.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM admin_reply WHERE id='$user_id' ";
