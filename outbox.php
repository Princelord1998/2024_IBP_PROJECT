...
<div class="document">
    ...
    <div class="sidebar" id="sidebar">
        <ul>
            ...
            <li><a href="outbox.php" style="background-color: red"><i class="fa fa-commenting-o" style="margin-right: 14px"></i>Outbox</a></li>
        </ul>
    </div>
    <div class="content">
            ...
            if(mysqli_num_rows($query_run) > 0)
            {
                foreach($query_run as $user)
                {
                    ...
                    <tr>
                        ...
                        <td><?= $user['date'];?></td>
                        <td>
                            <a href="sent_message_view.php?id=<?= $user['id']; ?>" class="btn btn-info btn-sm">View</a>
                            <form action="action.php" method="POST" class="d-inline">
                                <button onclick="return confirm('Are you sure you wanna delete message?')" style="width: 60px" type="submit" name="delete_user_message_sent" value="<?=$user['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                            </form>
                        </td>
                    </tr>
                    <?php
