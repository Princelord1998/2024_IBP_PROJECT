...
<div class="document">
    ...
    <div class="sidebar" id="sidebar">
        <ul>
            ...
            <li><a href="messages.php" style="background-color: red"><i class='fas fa-paper-plane' style="margin-right: 14px"></i>send message</a></li>
        ...
        <div class="container">
            ...
            <form action="send_message.php" method="post">
                <div class="form-group">
                    <textarea id="message" name="message" rows="4" cols="60" style="background-color: inherit" required></textarea>
                </div>
                <button type="submit" name="submit" style="width: 60px">Send</button>
            </form>
        </div>
    </div>
</div>
